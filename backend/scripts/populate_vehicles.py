...
from app.models.Veiculos import Veiculo, CategoriaVeiculo, StatusVeiculo  # Corrigido o import
    ...
    try:
        ...
        vehicles_data = [
            # 🟢 CATEGORIA ECONÔMICO (3 veículos)
            {
                ...
                "cor": "Branco",  # Adicionei cor
                "categoria": CategoriaVeiculo.ECONOMICO, 
                "valor_diaria": 89.90,  # Mudei de 'diaria' para 'valor_diaria'
            ...
            },
            {
                ...
                "cor": "Prata",
                "categoria": CategoriaVeiculo.ECONOMICO, 
                "valor_diaria": 79.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
            ...
            },
            {
                ...
                "cor": "Preto",
                "categoria": CategoriaVeiculo.ECONOMICO, 
                "valor_diaria": 95.00,  # Mudei de 'diaria' para 'valor_diaria'
            ...
            # 🟡 CATEGORIA INTERMEDIÁRIO (3 veículos)
            {
                ...
                "valor_diaria": 159.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
            ...
            },
            {
                ...
                "cor": "Vermelho",
                "categoria": CategoriaVeiculo.INTERMEDIARIO, 
                "valor_diaria": 169.90,  # Mudei de 'diaria' para 'valor_diaria'
            ...
            },
            {
                ...
                "cor": "Azul",
                "categoria": CategoriaVeiculo.INTERMEDIARIO, 
                "valor_diaria": 149.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
            ...
            # 🔵 CATEGORIA SUV (3 veículos)
            {
                ...
                "valor_diaria": 229.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
            ...
            },
            {
                ...
                "cor": "Branco",
                "categoria": CategoriaVeiculo.SUV, 
                "valor_diaria": 219.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
            ...
            },
            {
                ...
                "cor": "Prata",
                "categoria": CategoriaVeiculo.SUV, 
                "valor_diaria": 239.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.MANUTENCAO,
            ...
            # 🔴 CATEGORIA LUXO (3 veículos)
            {
                ...
                "valor_diaria": 399.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
            ...
            },
            {
                ...
                "cor": "Preto",
                "categoria": CategoriaVeiculo.LUXO, 
                "valor_diaria": 429.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.LOCADO,
            ...
            },
            {
                ...
                "cor": "Cinza",
                "categoria": CategoriaVeiculo.LUXO, 
                "valor_diaria": 389.90,  # Mudei de 'diaria' para 'valor_diaria'
                "status": StatusVeiculo.DISPONIVEL,
